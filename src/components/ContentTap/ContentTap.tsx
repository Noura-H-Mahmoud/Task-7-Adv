        ...
        <div className="flex justify-center gap-4 md:gap-0 flex-col md:flex-row">
            <div className="flex gap-3 max-[1275px]:grid max-[1275px]:grid-cols-1 md:grid-cols-2">
                ...
                <DropdownField
                    ...
                    className="pr-3 1410:pr-[43.5px] border-r-[1px] border-blackColor max-[1275px]:border-none"
                />
                <DropdownField
                    ...
                    className="pr-3 1410:pr-7 border-r-[1px] border-blackColor max-[1275px]:border-none"
                />
                <DropdownField
                    icon={tour.src}
                    label="Tour"
